...
import { useAgentLoginHook, type LoginValues } from "@/hooks";
...
export default function AgentLoginPage({ onClose, onLogin }: LoginProps) {
  const [showPassword, setShowPassword] = useState(false);

  // Use the agent login hook
    ...
    >
      <Formik
        ...
        onSubmit={async (values, { setSubmitting }) => {
          console.log("✅ Agent Login Submitted:", values);

          // Call the agent login hook
          ...
          <Form className="w-full max-w-md mx-3 bg-white p-8 rounded-2xl shadow-lg space-y-6 text-[14px] leading-[145%]">
            ...
            <div className="flex items-center gap-3 flex-col">
              ...
              <h1 className="text-[16px] font-medium text-gray-500 text-center">
                Agent Portal - Enter your credentials
              </h1>
            </div>
