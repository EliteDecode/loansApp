...
import { useManagerLoginHook, type LoginValues } from "@/hooks";
...
export default function ManagerLoginPage({ onClose, onLogin }: LoginProps) {
  const [showPassword, setShowPassword] = useState(false);

  // Use the manager login hook
    ...
    >
      <Formik
        ...
        onSubmit={async (values, { setSubmitting }) => {
          console.log("✅ Manager Login Submitted:", values);

          // Call the manager login hook
          ...
          <Form className="w-full max-w-md mx-3 bg-white p-8 rounded-2xl shadow-lg space-y-6 text-[14px] leading-[145%]">
            ...
            <div className="flex items-center gap-3 flex-col">
              ...
              <h1 className="text-[16px] font-medium text-gray-500 text-center">
                Manager Portal - Enter your credentials
              </h1>
            </div>
